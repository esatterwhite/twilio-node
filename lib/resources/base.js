...
var base = new Base({
    "version":"compat/twil/dev"
    ,"host":"aortlieb-freeswitch:8002"
    ,"resource":"Calls"
...
Base.prototype = /** @lends module:lib/resources/base.Base.prototype */{
     ...
     * @param {Function} [callback] optional callback to be executed when the http request completes
     **/
    , update: function( sid, callback ){
        return this.put( sid, callback );
    }
        ...
        request(options,function(err, response, body ){
            ...
            if (err || (response && (response.statusCode < 200 || response.statusCode > 206))) {
                ...
                if (response) {
                    ...
                    error.message  = "Unable to reach host: \""+that.options.host+"\"";
                }
            }
            processKeys(data);
